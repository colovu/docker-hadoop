...
APP_DIRS="${APP_DIRS} ${HADOOP_TMP_DIR} ${HDFS_NAMENODE_DATA_DIR} ${HDFS_DATANODE_DATA_DIR} ${HDFS_JOURNALNODE_DATA_DIR} ${YARN_TIMELINE_DATA_DIR} ${MAPRED_JOBHISTORY_DONE_DATA_DIR} ${MAPRED_JOBHISTORY_TMP_DATA_DIR} "
